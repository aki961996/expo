...
def _seed_expo_events():
    ...
    events = [
        ...
        {"doctype": "Expo Event", "name": "SIFS2026", "event_name": "South India Food Summit 2026", "event_short_code": "SIFS2026", "category": "Expo", "business_type": "Food & Beverage", "organizer_name": "FSSAI South India", "description": "<p>Premier food and beverage expo covering restaurant tech, packaging, ingredients, and food processing machinery. 300+ brands under one roof.</p>", "start_date": add_days(today(), 60), "end_date": add_days(today(), 63), "setup_start_date": add_days(today(), 58), "dismantle_date": add_days(today(), 64), "venue_name": "CODISSIA Trade Fair Complex", "city": "Coimbatore", "country": "India", "status": "Upcoming", "is_published": 1, "visitor_capacity": 30000, "exhibitor_capacity": 300, "has_wifi": 1, "has_ac": 1, "has_food_court": 1, "has_atm": 1, "has_first_aid": 1, "has_fire_safety": 1, "has_security": 1, "has_drinking_water": 1, "has_prayer_room": 1,"parking_cars": 1500, "parking_trucks": 100, "washrooms_male": 15, "washrooms_female": 15, "washrooms_accessible": 4},
